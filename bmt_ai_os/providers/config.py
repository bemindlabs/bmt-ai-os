...
Configuration priority (highest wins):
  ...
  3. Secrets file (/etc/bmt_ai_os/secrets/<KEY_NAME>)
...
def resolve_api_key(
    *,
    ...
    3. Secrets file at ``/etc/bmt_ai_os/secrets/<key_name>``
    """
    if explicit:
        return explicit
