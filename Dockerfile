...
#
# Usage:
#   docker build -t bmt_ai_os:latest .
#   docker run -p 8080:8080 --network bmt-ai-net bmt_ai_os:latest

FROM python:3.12-slim AS base

LABEL maintainer="Bemind Technology Co., Ltd."
LABEL org.opencontainers.image.source="https://github.com/bemindlabs/bmt_ai_os"
