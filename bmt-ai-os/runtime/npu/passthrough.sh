#!/bin/sh
# /usr/lib/bmt-ai-os/passthrough.sh
...
main() {
    ...
    echo "BMT_ACCEL=${BMT_ACCEL}" > /run/bmt-ai-os/accel.env 2>/dev/null || true
    echo "BMT_NPU_BACKEND=${BMT_NPU_BACKEND}" >> /run/bmt-ai-os/accel.env 2>/dev/null || true
}
